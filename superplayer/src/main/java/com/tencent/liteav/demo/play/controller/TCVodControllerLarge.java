...
//    private SeekBar mSeekBarProgress;
    ...
    private boolean mDanmukuOn = false;
...
//    private ProgressBar mPbLiveLoading;
    ...
    void onShow() {
        ...
        if (this.getHandler() != null && mHideLockViewRunnable != null) {
...
//    }
    ...
    public void setmDanmuku(boolean on) {
        mDanmukuOn = on;
        if (on) {
            mIvDanmuku.setImageResource(R.drawable.ic_danmuku_on);
        } else {
    ...
    public boolean getmDanmuku() {
        return mDanmukuOn;

    }

    public void setmIvDanmukuVisibility(int visibility) {
        mIvDanmuku.setVisibility(visibility);
    }
